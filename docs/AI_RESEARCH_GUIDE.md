...
flowchart TD
    ...
    P240 --> H72
    P221 --> P242["P242 intrinsic height and finite attainment"]
    P242 --> P243["P243 geodesic reduction without X02"]
    H112 --> P243
    P115 --> P243
    P243 --> H72
...
| H112 | `OPEN` | Force infinitely many nonzero source lifts on every infinite safe all-prefix same-Q-geodesic branch; P243 gives the full nonperiodic implication without X02 | Use the H112 pack, normalized-height descent and growing P238 collisions with P235 carry/P237 deficit. Preserve NG43 safety/valley rescue and source167; a finite Bellman plateau is not a stopping certificate |
