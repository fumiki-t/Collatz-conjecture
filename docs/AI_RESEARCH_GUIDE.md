...
proof of the conjecture. Phase 39's macroscopic-carry and geodesic audit
is the latest research layer.

## Read in this order

1. [`RESEARCH_SYNTHESIS.md`](RESEARCH_SYNTHESIS.md) — conventions, global
   branch map, Phase 1–39 evidence boundaries, and current obligations.
...
6. [`../PHASE39_RUN_RESULTS.md`](../PHASE39_RUN_RESULTS.md),
   ...
   then [`../PHASE38_RUN_RESULTS.md`](../PHASE38_RUN_RESULTS.md), especially
...
flowchart TD
    ...
    P194 --> H172
    P127 --> H112
    H112 --> P240["P240 conditional on X02 and P228/E54"]
    P240 --> H72
...
P129--P138, P140, P141, P144, P145, P147--P229, P231--P239, P241 are
...
| H112 | `OPEN` | Force infinitely many nonzero source lifts on every infinite safe all-prefix same-Q-geodesic branch; P240 gives the full nonperiodic implication under X02 | Use the dedicated H112 pack and growing P238 collisions satisfying P235 carry/P237 deficit; reject identity/periodic exceptions and source-167 finite zero-run inference |
